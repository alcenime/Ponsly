 ...
 *
 * Chain slug verified: GMGN uses "robinhood" as the chain slug
 * for Robinhood Chain consistently across their public CLI
 * (`gmgn-cli --chain robinhood`), their market-data skill docs,
 * and their web app (gmgn.ai/?chain=robinhood).
 */
